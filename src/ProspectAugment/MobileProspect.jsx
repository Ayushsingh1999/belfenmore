...
export default function MobileProspect() {
  return (
    <div className="main-container w-[390px] h-[5800px] bg-[#fffdec] relative overflow-hidden mx-auto my-0">
      ...
      <div className="flex w-[351.25px] h-[36px] justify-between items-center relative z-[119] mt-[21.466px] mr-0 mb-0 ml-[20.75px]">
        <div className="w-[145px] h-[22px] shrink-0 font-['Editor's_Note'] text-[30.571701049804688px] font-[1] leading-[22px] relative text-left whitespace-nowrap z-[119]">
        ...
        <div className="flex w-[36px] pt-[10px] pr-[10px] pb-[10px] pl-[10px] gap-[10px] items-center shrink-0 flex-nowrap bg-[rgba(245,241,225,0.8)] rounded-[6px] relative z-[116]">
          <div className="w-[16px] h-[16px] shrink-0 bg-[url(https://codia-f2c.s3.us-west-1.amazonaws.com/image/2026-03-23/D0FV7encwd.png)] bg-cover bg-no-repeat relative overflow-hidden z-[117]" />
        </div>
      </div> */}
  ...
  />
      ...
      <div className="w-[250px] h-[241.162px] bg-[url(https://codia-f2c.s3.us-west-1.amazonaws.com/image/2026-03-23/cuxXju5KGU.png)] bg-cover bg-no-repeat relative overflow-hidden z-[8] mt-[90.411px] mr-0 mb-0 ml-[70px]">
        <span className="flex h-[25px] justify-start items-start font-['Times_Now'] text-[22px] font-semibold leading-[25px] text-[#25241e] absolute top-[calc(50%-111.58px)] left-[calc(50%-116px)] text-left whitespace-nowrap z-[9]">
          Finance
        </span>
      </div>
      ...
      <div className="w-[250px] h-[241.162px] bg-[url(https://codia-f2c.s3.us-west-1.amazonaws.com/image/2026-03-23/WV6pwiF2wL.png)] bg-cover bg-no-repeat relative overflow-hidden z-[12] mt-[90px] mr-0 mb-0 ml-[70px]">
        <span className="flex h-[25px] justify-start items-start font-['Times_Now'] text-[22px] font-semibold leading-[25px] text-[#25241e] absolute top-[calc(50%-111.74px)] left-[calc(50%-116px)] text-left whitespace-nowrap z-[13]">
          FMCG
        </span>
      </div>
      ...
      <div className="w-[250px] h-[241.162px] bg-[url(https://codia-f2c.s3.us-west-1.amazonaws.com/image/2026-03-23/jBOeGJ9Jan.png)] bg-cover bg-no-repeat relative overflow-hidden z-[15] mt-[90px] mr-0 mb-0 ml-[70px]">
        <span className="flex h-[25px] justify-start items-start font-['Times_Now'] text-[22px] font-semibold leading-[25px] text-[#25241e] absolute top-[calc(50%-111.81px)] left-[calc(50%-116.23px)] text-left whitespace-nowrap z-[16]">
          Industrial
        </span>
      </div>
      ...
      <div className="w-[250px] h-[241.162px] bg-[url(https://codia-f2c.s3.us-west-1.amazonaws.com/image/2026-03-23/Or0i8dmsSL.png)] bg-cover bg-no-repeat relative overflow-hidden z-[18] mt-[90px] mr-0 mb-0 ml-[70px]">
        <span className="flex h-[25px] justify-start items-start font-['Times_Now'] text-[22px] font-semibold leading-[25px] text-[#25241e] absolute top-[calc(50%-111.81px)] left-[calc(50%-116.23px)] text-left whitespace-nowrap z-[19]">
          Medical
        </span>
      </div>
      ...
      <div className="w-[322px] h-[127.865px] relative z-[23] mt-[129.733px] mr-0 mb-0 ml-[34px] translate-y-[170px]">
        ...
        <span className="flex h-[76px] justify-start items-start font-['Meie_Script'] text-[60px] font-normal leading-[75.996px] text-[#fffdec] absolute top-[calc(50%-62.93px)] left-[calc(50%-80.24px)] text-left whitespace-nowrap z-[23]">
          journey
        </span>
        <span className="flex w-[258px] h-[28px] justify-center items-start font-['Times_Now'] text-[24px] font-[250] leading-[27.6px] text-[#32312b] absolute top-[calc(50%-46.07px)] left-[calc(50%-129px)] text-center uppercase whitespace-nowrap z-20">
          We are part of your
        </span>
...
<span className="block text-[#F4F2DF] font-['Luxurious_Script'] text-[174px] leading-[210px] mt-[58px]">
  Envision
      ...
      <div className="flex w-[235px] gap-[9.6px] justify-center items-center flex-nowrap relative z-[101] mt-[12px] mr-0 mb-0 ml-[77.5px]">
        <span className="h-[12px] shrink-0 basis-auto font-['Times_Now'] text-[10px] font-light leading-[11.5px] text-[#32312b] relative text-left whitespace-nowrap z-[102]">
          USA
        </span>
        <div className="w-[3px] h-[3px] shrink-0 bg-[url(https://codia-f2c.s3.us-west-1.amazonaws.com/image/2026-03-23/HM43V8yJpr.png)] bg-cover bg-no-repeat rounded-[50%] relative z-[103]" />
        <span className="h-[12px] shrink-0 basis-auto font-['Times_Now'] text-[10px] font-light leading-[11.5px] text-[#32312b] relative text-left whitespace-nowrap z-[104]">
          UK
        </span>
        <div className="w-[3px] h-[3px] shrink-0 bg-[url(https://codia-f2c.s3.us-west-1.amazonaws.com/image/2026-03-23/mUbgvinyoG.png)] bg-cover bg-no-repeat rounded-[50%] relative z-[105]" />
        <span className="h-[12px] shrink-0 basis-auto font-['Times_Now'] text-[10px] font-light leading-[11.5px] text-[#32312b] relative text-left whitespace-nowrap z-[106]">
          MENA
        </span>
        <div className="w-[3px] h-[3px] shrink-0 bg-[url(https://codia-f2c.s3.us-west-1.amazonaws.com/image/2026-03-23/2RYSz8cB04.png)] bg-cover bg-no-repeat rounded-[50%] relative z-[107]" />
        <span className="h-[12px] shrink-0 basis-auto font-['Times_Now'] text-[10px] font-light leading-[11.5px] text-[#32312b] relative text-left whitespace-nowrap z-[108]">
          APAC
        </span>
        <div className="w-[3px] h-[3px] shrink-0 bg-[url(https://codia-f2c.s3.us-west-1.amazonaws.com/image/2026-03-23/Q2K5rS9NOE.png)] bg-cover bg-no-repeat rounded-[50%] relative z-[109]" />
        <span className="h-[12px] shrink-0 basis-auto font-['Times_Now'] text-[10px] font-light leading-[11.5px] text-[#32312b] relative text-left whitespace-nowrap z-[110]">
          NL
        </span>
        <div className="w-[3px] h-[3px] shrink-0 bg-[url(https://codia-f2c.s3.us-west-1.amazonaws.com/image/2026-03-23/2pUEhKqb60.png)] bg-cover bg-no-repeat rounded-[50%] relative z-[111]" />
        <span className="h-[12px] shrink-0 basis-auto font-['Times_Now'] text-[10px] font-light leading-[11.5px] text-[#32312b] relative text-left whitespace-nowrap z-[112]">
          AUS
        </span>
      </div>
      <div className="flex w-[169px] flex-col gap-[10px] items-start flex-nowrap relative z-[82] mt-[46px] mr-0 mb-0 ml-[34px]">
        <span className="h-[15px] shrink-0 basis-auto font-['Times_Now'] text-[13px] font-[250] leading-[14.95px] text-[#32312b] relative text-left whitespace-nowrap z-[83]">
          Connect with us
        </span>
        <div className="flex gap-[4px] justify-center items-center self-stretch shrink-0 flex-nowrap relative z-[84]">
          <span className="h-[19px] shrink-0 basis-auto font-['Cabinet_Grotesk_Variable'] text-[15px] font-bold leading-[18.6px] text-[#32312b] relative text-left whitespace-nowrap z-[85]">
            more@belfenmore.com
          </span>
          <div className="w-[10px] h-[10px] shrink-0 bg-[url(https://codia-f2c.s3.us-west-1.amazonaws.com/image/2026-03-23/0Sb0BVbO53.png)] bg-cover bg-no-repeat relative overflow-hidden z-[86]" />
        </div>
      </div>
      <div className="flex w-[142px] flex-col gap-[10px] items-start flex-nowrap relative z-[87] mt-[46px] mr-0 mb-0 ml-[34px]">
        <span className="h-[15px] shrink-0 basis-auto font-['Times_Now'] text-[13px] font-[250] leading-[14.95px] text-[#32312b] relative text-left whitespace-nowrap z-[88]">
          Sustainability
        </span>
        <div className="flex gap-[5px] justify-center items-center self-stretch shrink-0 flex-nowrap relative z-[89]">
          <span className="h-[19px] shrink-0 basis-auto font-['Cabinet_Grotesk_Variable'] text-[15px] font-bold leading-[18.6px] text-[#32312b] relative text-left whitespace-nowrap z-[90]">
            Our Byrds Journey
          </span>
          <div className="w-[10px] h-[10px] shrink-0 bg-[url(https://codia-f2c.s3.us-west-1.amazonaws.com/image/2026-03-23/bEzEsSd4Mg.png)] bg-cover bg-no-repeat relative overflow-hidden z-[91]" />
        </div>
      </div>
      <div className="flex w-[133px] flex-col gap-[10px] items-start flex-nowrap relative z-[92] mt-[46px] mr-0 mb-0 ml-[34px]">
        <span className="h-[15px] shrink-0 basis-auto font-['Times_Now'] text-[13px] font-[250] leading-[14.95px] text-[#32312b] relative text-left whitespace-nowrap z-[93]">
          Design
        </span>
        <div className="flex gap-[5px] justify-center items-center self-stretch shrink-0 flex-nowrap relative z-[94]">
          <span className="h-[19px] shrink-0 basis-auto font-['Cabinet_Grotesk_Variable'] text-[15px] font-bold leading-[18.6px] text-[#32312b] relative text-left whitespace-nowrap z-[95]">
            Morphline studios
          </span>
